...
3. Ezra Yuniar Sibarani:  Membuat Test Case Document yang di dimana terdapat positif dan negatif scenario yang dikreasikan pada Google spreadsheets (Create account, Update my account, Log In, Log Out, Select product and add cart, Process to CheckOut, and Shoping Cart Page)
